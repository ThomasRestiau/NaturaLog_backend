package be.restiau.interactivesatlasspecies_v3.bll.services.security.impls;
...
import be.restiau.interactivesatlasspecies_v3.bll.exceptions.user.EmailAlreadyExistsException;
import be.restiau.interactivesatlasspecies_v3.bll.exceptions.user.UsernameAlreadyExistsException;
import be.restiau.interactivesatlasspecies_v3.bll.mappers.UserMapper;
import be.restiau.interactivesatlasspecies_v3.dal.repositories.UserRepository;
...
import be.restiau.interactivesatlasspecies_v3.il.utils.JwtUtil;
...
//        savedUser.setId(1L); // Décommenter le @Setter dans dl/entities/BaseEntity
        ...
        userDTO = new UserDTO("jdoe", "John", "Doe", "jdoe@email.com", LocalDate.of(1990, 1, 1));
    }
    ...
    void login_shouldReturnUserTokenDTO_whenCredentialsAreCorrect() {
        ...
        assertEquals("John Doe", result.user().fullName());
    }
